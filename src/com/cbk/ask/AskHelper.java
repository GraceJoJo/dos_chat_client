...
import com.cbk.ask.db.DemoDBManager;
import com.cbk.ask.db.InviteMessgeDao;
import com.cbk.ask.db.UserDao;
import com.cbk.ask.domain.EmojiconExampleGroupData;
import com.cbk.ask.domain.InviteMessage;
import com.cbk.ask.domain.InviteMessage.InviteMesageStatus;
import com.cbk.ask.domain.RobotUser;
import com.cbk.ask.parse.UserProfileManager;
import com.cbk.ask.receiver.CallReceiver;
import com.cbk.ask.ui.ChatActivity;
import com.cbk.ask.ui.MainActivity;
import com.cbk.ask.ui.VideoCallActivity;
import com.cbk.ask.ui.VoiceCallActivity;
import com.cbk.ask.utils.PreferenceManager;
...
public class AskHelper {
    ...
    protected static final String TAG = "AskHelper";
	...
	private static AskHelper instance = null;
	
	private AskModel askModel = null;
	...
	public synchronized static AskHelper getInstance() {
		if (instance == null) {
			instance = new AskHelper();
		}
		return instance;
	}
	...
	private EMOptions initChatOptions(){
        ...
        if(askModel.isCustomServerEnable() && askModel.getRestServer() != null && askModel.getIMServer() != null) {
            options.setRestServer(askModel.getRestServer());
            options.setIMServer(askModel.getIMServer());
            if(askModel.getIMServer().contains(":")) {
                options.setIMServer(askModel.getIMServer().split(":")[0]);
                options.setImPort(Integer.valueOf(askModel.getIMServer().split(":")[1]));
            }
        }

        if (askModel.isCustomAppkeyEnabled() && askModel.getCutomAppkey() != null && !askModel.getCutomAppkey().isEmpty()) {
            options.setAppKey(askModel.getCutomAppkey());
        }
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseSettingsProvider() {
            ...
            public boolean isSpeakerOpened() {
                return askModel.getSettingMsgSpeaker();
            }
            
            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return askModel.getSettingMsgVibrate();
            }
            
            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return askModel.getSettingMsgSound();
            }
            
            @Override
            public boolean isMsgNotifyAllowed(EMMessage message) {
                if(message == null){
                    return askModel.getSettingMsgNotification();
                }
                if(!askModel.getSettingMsgNotification()){
                    return false;
                }else{
                    ...
                    if (message.getChatType() == ChatType.Chat) {
                        ...
                        notNotifyIds = askModel.getDisabledIds();
                    } else {
                        chatUsename = message.getTo();
                        notNotifyIds = askModel.getDisabledGroups();
                    }
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = askModel.isGroupsSynced();
        isContactsSyncedWithServer = askModel.isContactSynced();
        isBlackListSyncedWithServer = askModel.isBacklistSynced();
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = AskHelper.getInstance().getContactList();
...
//                        }
	...
	public AskModel getModel(){
        return (AskModel) askModel;
    }
    ...
    public Map<String, EaseUser> getContactList() {
        if (isLoggedIn() && contactList == null) {
            contactList = askModel.getContactList();
        }
    ...
    public void setCurrentUserName(String username){
    	...
    	askModel.setCurrentUserName(username);
    }
    ...
    public String getCurrentUsernName(){
    	if(username == null){
    		username = askModel.getCurrentUsernName();
    	}
    	return username;
    }
	...
	public Map<String, RobotUser> getRobotList() {
		if (isLoggedIn() && robotList == null) {
			robotList = askModel.getRobotList();
		}
		return robotList;
	}
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
         ...
         askModel.saveContactList(mList);
    }
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   askModel.setGroupsSynced(false);
                   isGroupsSyncedWithServer = false;
                   isSyncingGroupsWithServer = false;
                   noitifyGroupSyncListeners(false);
                   if(callback != null){
       ...
       new Thread(){
           ...
           public void run(){
               ...
               try {
                   ...
                   askModel.setContactSynced(true);
                   ...
                   askModel.setContactSynced(false);
                   isContactsSyncedWithServer = false;
                   isSyncingContactsWithServer = false;
                   notifyContactsSyncListener(false);
                   e.printStackTrace();
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   askModel.setBlacklistSynced(true);
                   ...
                   askModel.setBlacklistSynced(false);
